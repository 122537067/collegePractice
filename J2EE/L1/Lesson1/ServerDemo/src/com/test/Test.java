...
public class Test 
{
	...
	{
		ServerSocket serverSocket = new ServerSocket(9001); //创建绑定到 端口：9001 的服务器套接字
		...
		PrintWriter pw = new PrintWriter(socketOut,true);   //通过socketOut创建pw
