...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="160" height="80" class="topbg"><img src="${ctx}/images/logo.png" width="160" height="80"></td>
	<td class="topbg">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <tr>
		  <td height="50" class="toplink" align="right">
			  <img src="${ctx}/images/chatting.png"><a href="javascript:void(0);" id="chatting">聊天室</a>&nbsp;&nbsp;
			  <img src="${ctx}/images/top_home.gif">&nbsp;&nbsp;<a href="javascript:void(0);">网站首页</a>
